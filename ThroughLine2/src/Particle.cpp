...
void Particle::render()
{
    ...
    //Effect 1 : tiny particles (DEFAULT)
    Color c = Color( agePer * 0.75f, agePer * 0.75f, agePer * 0.75f);
    renderImage( loc[0], radius * agePer * 1.5f, c, 1.0f );
    
    
    //Effect 2 : gray dust
    //Color c = Color( agePer * 0.2f, agePer * 0.2f, agePer * 0.2f);
    //renderImage( loc[0], radius * agePer * 8.f, c, .7f );
    
    //Effect 3 : random blue light particles
    //Color c = Color( agePer * 0.2f, agePer * 0.25f, agePer * 0.5f);
    //renderImage( loc[0], radius * agePer * Rand::randFloat( 8.0f ), c, 1.0f );
}
